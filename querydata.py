...
class querydata(BaseHandler):
    ...
    def post(self):
        ...
        if name != "":
            ...
            self.write({"head_1":head_1,"head_2":head_2,"head_3":head_3,"head_4":head_4,"query_data_1":query_data_1,
                        "query_data_2":query_data_2,"query_data_3":query_data_3,"query_data_4":query_data_4})
            print()
        else :
            print('查询参数为空')
        print('第一种方式查询成功')
